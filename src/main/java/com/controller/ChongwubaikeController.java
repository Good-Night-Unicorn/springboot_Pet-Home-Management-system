...
public class ChongwubaikeController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ChongwubaikeEntity chongwubaike,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ChongwubaikeEntity chongwubaike, 
		HttpServletRequest request){
        //设置查询条件
        EntityWrapper<ChongwubaikeEntity> ew = new EntityWrapper<ChongwubaikeEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(chongwubaike,deSens);
    ...
    public R save(@RequestBody ChongwubaikeEntity chongwubaike, HttpServletRequest request){
        ...
        return R.ok().put("data",chongwubaike.getId());
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ChongwubaikeEntity chongwubaike, HttpServletRequest request,String pre){
        EntityWrapper<ChongwubaikeEntity> ew = new EntityWrapper<ChongwubaikeEntity>();
    ...
    public R autoSort2(@RequestParam Map<String, Object> params,ChongwubaikeEntity chongwubaike, HttpServletRequest request){
        String userId = request.getSession().getAttribute("userId").toString();
        Integer limit = params.get("limit")==null?10:Integer.parseInt(params.get("limit").toString());
        List<StoreupEntity> storeups = storeupService.selectList(new EntityWrapper<StoreupEntity>().eq("type", 1).eq("tablename", "chongwubaike"));
        ...
        // 根据协同结果查询结果并返回
        PageUtils page = chongwubaikeService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, chongwubaike), params), params));;
        List<ChongwubaikeEntity> pageList = (List<ChongwubaikeEntity>)page.getList();
        if(recommendations!=null && recommendations.size()>0 && pageList.size()<limit) {
            int toAddNum = limit-pageList.size();
            ew = new EntityWrapper<ChongwubaikeEntity>();
            ew.notIn("id", recommendations);
            ew.orderBy("id", false);
            ew.last("limit "+toAddNum);
            pageList.addAll(chongwubaikeService.selectList(ew));
