	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__fadeInRight' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于SpringBoot的宠物之家管理系统的设计与实现注册</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="yuangonggonghao">
					...
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="shoujihao">
						<div class="label" :class="changeRules('shoujihao')?'required':''">手机号：</div>
						<el-input v-model="registerForm.shoujihao"  placeholder="请输入手机号" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="gangwei">
						<div class="label" :class="changeRules('gangwei')?'required':''">岗位：</div>
						<el-input v-model="registerForm.gangwei"  placeholder="请输入岗位" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='yuangong'" prop="zhiwei">
						<div class="label" :class="changeRules('zhiwei')?'required':''">职位：</div>
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.container {
		background: url(http://codegen.caihongy.cn/20250206/8540977184b84bb2b64e4be7f7e1bab3.png) center / 100% 100%;
		display: flex;
		width: 100%;
		min-height: 100vh;
