<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="岗位" prop="gangwei">
				<el-input v-model="ruleForm.gangwei" 
					placeholder="岗位" clearable :disabled=" false  ||ro.gangwei"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="职位" prop="zhiwei">
