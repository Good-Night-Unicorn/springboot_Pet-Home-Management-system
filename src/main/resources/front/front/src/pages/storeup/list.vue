<template>
	<div :style='{"width":"100%","padding":"20px","margin":"10px auto","position":"relative","background":"none","maxWidth":"1200px"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0","margin":"0 0 30px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20250206/913c65e0ee3248549258d770e7c33614.png) no-repeat center","width":"100%","letterSpacing":"2px","lineHeight":"80px","fontSize":"22px","fontWeight":"600"}'>我的收藏</div>
