	...
	<div>
		<div class="register-container">
			<el-form v-if="pageFlag=='register'" ref="ruleForm" class="rgs-form animate__animated animate__backInDown" :model="ruleForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于SpringBoot的宠物之家管理系统的设计与实现</div>
					...
					<el-form-item class="list-item" v-if="tableName=='yuangong'">
						<div class="lable" :class="changeRules('gangwei')?'required':''">岗位：</div>
						<el-input  v-model="ruleForm.gangwei"  autocomplete="off" placeholder="岗位"  type="text"  />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='yuangong'">
						<div class="lable" :class="changeRules('zhiwei')?'required':''">职位：</div>
